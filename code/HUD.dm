...
mob
	proc
		...
		CreateContainerMenu(var/obj/Con)
			...
			src.Text("Weight",src,10,2,1,10,"Weight - [round(Con.Weight, 0.01)]/[round(Con.WeightMax, 0.01)]")
			...
			for(var/obj/Items/I in src)
				if(I.Xloc == src.MouseLocationX)
					if(I.Yloc == src.MouseLocationY)
						...
						src.Text("BoxDelete",src,WeightLocX,WeightLocY,8,13,"Weight-[round(I.Weight, 0.01)]")
						if(I.CraftPotential)
							src.Text("BoxDelete",src,PurityX,PurityY,8,13,"Potential-[round(I.CraftPotential, 0.01)]")
						if(I.Defence)
							src.Text("BoxDelete",src,SlotLocX,SlotLocY,8,13,"Defence-[round(I.Defence, 0.01)]")
						if(I.Quality)
							var/DMG = I.Quality
							src.Text("BoxDelete",src,SlotLocX,SlotLocY,8,13,"Damage-[round(DMG, 0.01)]")
						if(I.Dura)
							src.Text("BoxDelete",src,DuraLocX,DuraLocY,8,13,"Durability-[round(I.Dura)]")
			return
		...
		CreateSkillDisplay()
			...
			src.Text("SkillDisplay",src,2,13,10,14,"SwordSkill-[round(src.SwordSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,12,10,14,"SpearSkill-[round(src.SpearSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,11,10,14,"BluntSkill-[round(src.BluntSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,10,10,14,"AxeSkill-[round(src.AxeSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,9,10,14,"DaggerSkill-[round(src.DaggerSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,8,10,14,"RangedSkill-[round(src.RangedSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,7,10,14,"UnarmedSkill-[round(src.UnarmedSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,6,10,14,"ShieldSkill-[round(src.ShieldSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,5,10,14,"Mining-[round(src.MiningSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,4,10,14,"Smelting-[round(src.SmeltingSkill, 0.01)]")
			src.Text("SkillDisplay",src,2,3,10,14,"FirstAid-[round(src.FirstAidSkill, 0.01)]")
			src.Text("SkillDisplay",src,6,13,10,14,"Forging-[round(src.ForgingSkill, 0.01)]")
			src.Text("SkillDisplay",src,6,12,10,14,"Masonary-[round(src.MasonarySkill, 0.01)]")
			src.Text("SkillDisplay",src,6,11,10,14,"Cooking-[round(src.CookingSkill, 0.01)]")
			src.Text("SkillDisplay",src,6,10,10,14,"Fishing-[round(src.FishingSkill, 0.01)]")
			src.Text("SkillDisplay",src,6,9,10,14,"Alchemy-[round(src.AlchemySkill, 0.01)]")
			src.Text("SkillDisplay",src,6,8,10,14,"LeatherCraft-[round(src.LeatherCraftSkill, 0.01)]")
			src.Text("SkillDisplay",src,6,7,10,14,"WoodCutting-[round(src.WoodCuttingSkill, 0.01)]")
			src.Text("SkillDisplay",src,6,6,10,14,"Building-[round(src.BuildingSkill, 0.01)]")
			src.Text("SkillDisplay",src,6,5,10,14,"Farming-[round(src.FarmingSkill, 0.01)]")
			src.Text("SkillDisplay",src,6,4,10,14,"Weaving-[round(src.WeavingSkill, 0.01)]")
			src.Text("SkillDisplay",src,6,3,10,14,"Carpentry-[round(src.CarpentrySkill, 0.01)]")
			src.Text("SkillDisplay",src,10,13,10,14,"Skinning-[round(src.SkinningSkill, 0.01)]")
			src.Text("SkillDisplay",src,10,12,10,14,"Butchery-[round(src.ButcherySkill, 0.01)]")
			src.Text("SkillDisplay",src,10,11,10,14,"Engraving-[round(src.EngravingSkill, 0.01)]")
			src.Text("SkillDisplay",src,10,10,10,14,"Swimming-[round(src.SwimmingSkill, 0.01)]")
			src.Text("SkillDisplay",src,10,9,10,14,"BoneCraft-[round(src.BoneCraftSkill, 0.01)]")
			src.Text("SkillDisplay",src,10,8,10,14,"Astral Magic-[round(src.AstralMagic, 0.01)]")
			src.Text("SkillDisplay",src,10,7,10,14,"Necromancy-[round(src.Necromancery, 0.01)]")
			src.Text("SkillDisplay",src,10,6,10,14,"Blood Magic-[round(src.BloodMagic, 0.01)]")
		CreateHealthDisplay()
			var/obj/H = new/obj/HUD/Menus/Scroll/ScrollMiddle(src.client)
			var/obj/F = new/obj/HUD/Menus/Scroll/ScrollLeft(src.client)
			var/obj/G = new/obj/HUD/Menus/Scroll/ScrollRight(src.client)
			...
			if(src.Race != "Snakeman")
				src.Text("HealthDisplay",src,2,13,1,14,"RightLeg-[round(src.RightLeg, 0.01)]%")
				src.Text("HealthDisplay",src,2,12,1,14,"LeftLeg-[round(src.LeftLeg, 0.01)]%")
			src.Text("HealthDisplay",src,2,11,1,14,"RightArm-[round(src.RightArm, 0.01)]%")
			src.Text("HealthDisplay",src,2,10,1,14,"LeftArm-[round(src.LeftArm, 0.01)]%")
			src.Text("HealthDisplay",src,2,9,1,14,"Nose-[round(src.Nose, 0.01)]%")
			src.Text("HealthDisplay",src,2,8,1,14,"LeftEar-[round(src.LeftEar, 0.01)]%")
			src.Text("HealthDisplay",src,2,7,1,14,"RightEar-[round(src.RightEar, 0.01)]%")
			src.Text("HealthDisplay",src,2,6,1,14,"Teeth-[round(src.Teeth, 0.01)]%")
			if(src.Race != "Cyclops")
				src.Text("HealthDisplay",src,2,5,1,14,"LeftEye-[round(src.LeftEye, 0.01)]%")
				src.Text("HealthDisplay",src,2,4,1,14,"RightEye-[round(src.RightEye, 0.01)]%")
			else
				src.Text("HealthDisplay",src,2,5,1,14,"Eye-[round(src.RightEye, 0.01)]%")
			src.Text("HealthDisplay",src,7,13,1,14,"Tongue-[round(src.Tongue, 0.01)]%")
			src.Text("HealthDisplay",src,7,12,1,14,"Skull-[round(src.Skull, 0.01)]%")
			src.Text("HealthDisplay",src,7,11,1,14,"Brain-[round(src.Brain, 0.01)]%")
			src.Text("HealthDisplay",src,7,10,1,14,"Heart-[round(src.Heart, 0.01)]%")
			src.Text("HealthDisplay",src,7,9,1,14,"LeftLung-[round(src.LeftLung, 0.01)]%")
			src.Text("HealthDisplay",src,7,8,1,14,"RightLung-[round(src.RightLung, 0.01)]%")
			src.Text("HealthDisplay",src,7,7,1,14,"Liver-[round(src.Liver, 0.01)]%")
			src.Text("HealthDisplay",src,7,6,1,14,"Spleen-[round(src.Spleen, 0.01)]%")
			src.Text("HealthDisplay",src,7,5,1,14,"LeftKidney-[round(src.LeftKidney, 0.01)]%")
			src.Text("HealthDisplay",src,7,4,1,14,"RightKidney-[round(src.RightKidney, 0.01)]%")
			src.Text("HealthDisplay",src,11,13,-5,14,"Intestines-[round(src.Intestine, 0.01)]%")
			src.Text("HealthDisplay",src,11,12,-5,14,"Stomach-[round(src.Stomach, 0.01)]%")
			src.Text("HealthDisplay",src,11,11,-5,14,"Throat-[round(src.Throat, 0.01)]%")
			if(src.Claws != 0)
				src.Text("HealthDisplay",src,11,10,-5,14,"Claws-[round(src.Claws, 0.01)]%")
		...
		CreateInfoDisplay()
			...
			src.Text("InfoDisplay",src,4,10,10,10,"Hunger-[round(src.Hunger, 0.01)]")
			src.Text("InfoDisplay",src,4,9,10,10,"Tiredness-[round(src.Sleep, 0.01)]")
			src.Text("InfoDisplay",src,4,8,10,10,"Strength-[round(src.Strength, 0.01)]")
			src.Text("InfoDisplay",src,4,7,10,10,"Agility-[round(src.Agility, 0.01)]")
			src.Text("InfoDisplay",src,4,6,10,10,"Endurance-[round(src.Endurance, 0.01)]")
			src.Text("InfoDisplay",src,4,5,10,10,"Intelligence-[round(src.Intelligence, 0.01)]")
